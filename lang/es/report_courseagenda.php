...
$string['defaultfilteroption'] = 'Opción de filtro predeterminada';
$string['defaultfilteroption_help'] = 'Seleccione la opción de filtro predeterminada para mostrar las actividades en el informe.';
$string['excludemodules'] = 'Excluir módulos';
$string['excludemodules_help'] = 'Seleccione los módulos que desea excluir del informe.';
$string['excludesections'] = 'Excluir secciones por nombre';
$string['excludesections_help'] = 'Ingrese los nombres de las secciones que desea excluir del informe, uno por línea. Si escribe solo texto, la coincidencia será exacta. Si necesita coincidencias parciales o por patrón, use una expresión regular. Por ejemplo, para excluir todas las secciones que inicien con "Semana", puede ingresar "^Semana" (sin comillas).';
$string['extensiondate_cutoff'] = 'La finalización de la actividad se extendió hasta <span>{$a}</span>';
$string['extensiondate_due'] = 'La actividad se extendió hasta <span>{$a}</span>';
$string['extensiondate_from'] = 'La actividad se extendió desde <span>{$a}</span>';
$string['extensiondate_general'] = 'La actividad se extendió para {$a} estudiantes';
$string['extensions_goto'] = 'Consultar';
...
$string['fullstate_retarded'] = 'Retrasada {$a} días';
...
$string['includehiddensectionsmods'] = 'Incluir actividades en secciones ocultas';
$string['includehiddensectionsmods_help'] = 'Cuando está habilitado, las actividades en secciones ocultas se incluirán en el informe. Estas actividades se mostrarán como bloqueadas.';
